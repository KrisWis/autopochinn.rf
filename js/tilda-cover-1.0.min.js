...
function t_cover__recalcCoverHeight(e, t) {
  ...
  if (o) {
    ...
    if (r && "935" !== n) {
      ...
      var l = "dynamic" === i.getAttribute("data-content-cover-parallax"),
        u = t_cover__getHeightFromAttr(c);
      u &&
        _.forEach(function (e) {
          var t;
          (l && ".t-cover__carrier" === e) ||
            Array.prototype.slice
              .call(o.querySelectorAll(e))
              .forEach(function (e) {
                e && (e.style.height = Math.round(u) + "px");
              });
        });
      var v = t_cover__getHeightFromAttr(c),
        ...
        g = v || s;
      if (!d) {
        var h = r.style.height;
        (r.style.height = ""), (g = s), h && (r.style.height = h);
      }
      var f = t_cover__getContentHeight(o),
        p = 40,
        m = 300,
      ...
      ((window.t_cover__isMobile || "ontouchend" in document) && t)
        ? (t_cover__setRecalculatedHeight(o, f), t_cover__updateResizeElem(o))
    ...
    v.forEach(function (t) {
      ...
      Array.prototype.slice.call(e.querySelectorAll(t)).forEach(function (e) {
        ...
        l < document.documentElement.clientHeight
          ? ((u = 0.2 * document.documentElement.clientHeight),
            (e.style.height = l + u + "px"))
          : e && (e.style.height = l + "px");
      });
    }),
    o.setAttribute("data-content-cover-updated-height", l + u + "px");
